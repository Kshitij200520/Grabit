...
// Real Shopping Website Style Product Catalog
const realShoppingProducts = [
  // Electronics & Technology (30 items) - Real Shopping Categories
  {
    ...
    featured: true,
    rating: 4.9,
    image: "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=50"
  },
  {
  ...
  },
  {
    ...
    featured: false,
    rating: 4.6,
    image: "https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
  ...
  },
  {
    ...
    featured: false,
    rating: 4.5,
    image: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
    ...
    featured: false,
    rating: 4.4,
    image: "https://images.unsplash.com/photo-1609592173516-1e7b83d39532?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
    ...
    featured: false,
    rating: 4.3,
    image: "https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
  ...
  },
  {
    ...
    featured: false,
    rating: 4.4,
    image: "https://images.unsplash.com/photo-1622609941360-4f4b33c8c000?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
  ...
  // Sports & Fitness (40 items) - Gym & Fitness Equipment
  {
  ...
  {
    name: "Hex Dumbbells Set 10-50 lbs",
    description: "Professional rubber hex dumbbells with ergonomic handles, anti-roll design, and durable construction",
    price: 899,
    category: "Sports & Fitness",
    stock: 15,
    featured: false,
  ...
  },
  {
    ...
    featured: false,
    rating: 4.3,
    image: "https://images.unsplash.com/photo-1594882645126-14020914d58d?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
    ...
    featured: false,
    rating: 4.4,
    image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
  ...
  // Fashion & Apparel (30 items) - Different Types of Clothing
  {
  ...
  // Home & Garden (35 items) - Home Accessories & Garden Items
  {
  ...
  },
  {
    ...
    featured: true,
    rating: 4.7,
    image: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=500&h=500&fit=crop&crop=center&auto=format"
  },
  {
...
const seedRealProducts = async () => {
  try {
    console.log('🛒 Seeding REAL SHOPPING WEBSITE style products...');
    console.log('📱 Just like Amazon, Flipkart, eBay - Authentic Categories!');
    
    // Clear existing products
    await Product.deleteMany({});
    console.log('🗑️ Cleared existing products');
    
    // Insert real shopping products
    await Product.insertMany(realShoppingProducts);
    console.log('✅ Real shopping products seeded successfully');
    
    const count = await Product.countDocuments();
    console.log(`📦 Total products in database: ${count}`);
    
    // Show category breakdown with specific items
    console.log('\n🛍️ REAL SHOPPING CATEGORIES:');
    
    console.log('\n📱 ELECTRONICS & TECH:');
    console.log('   • Latest Smartphones (iPhone 17 Pro, Samsung S25)');
    console.log('   • Smart Watches & Analog Watches (Apple Watch, Rolex)');
    console.log('   • Premium Earbuds & Headphones (AirPods Pro, Sony)');
    console.log('   • Laptops & Computers (MacBook, Dell XPS)');
    console.log('   • Chargers & Power Banks (USB-C, Wireless)');
    
    console.log('\n💪 SPORTS & FITNESS:');
    console.log('   • Gym Equipment (Dumbbells, Resistance Bands)');
    console.log('   • Yoga & Exercise Mats (Premium, Extra Thick)');
    console.log('   • Fitness Supplements (Protein Powder, BCAA)');
    console.log('   • Strength Training (Battle Ropes, Suspension Trainer)');
    console.log('   • Workout Accessories (Gymnastic Rings, Pull-up Bands)');
    
    console.log('\n👕 FASHION & CLOTHING:');
    console.log('   • Athletic Wear (Nike Dri-FIT, Adidas Track Jackets)');
    console.log('   • Casual Wear (Levi\'s Jeans, Ralph Lauren Polo)');
    console.log('   • Footwear (Nike Air Force, Adidas Stan Smith)');
    console.log('   • Winter Wear (Puffer Jackets, Wool Sweaters)');
    console.log('   • Casual & Formal Shirts (Tommy Hilfiger, Oxford)');
    
    console.log('\n🏠 HOME & GARDEN:');
    console.log('   • Home Accessories (Throw Pillows, Table Lamps)');
    console.log('   • Decorative Items (Wall Art, Ceramic Vases)');
    console.log('   • Garden Supplies (Tool Sets, Raised Beds)');
    console.log('   • Outdoor Living (Solar Lights, String Lights)');
    console.log('   • Plants & Gardening (Indoor Plants, Succulent Kits)');
...
// Run seeding
seedRealProducts().then(() => {
  console.log('\n🎉 REAL SHOPPING WEBSITE CATALOG COMPLETED!');
  console.log('🏪 Authentic product categories just like major e-commerce sites');
  console.log('📱 Electronics: Latest phones, watches, laptops, chargers');
  console.log('💪 Fitness: Gym mats, dumbbells, protein powder, resistance bands');
  console.log('👕 Fashion: Athletic wear, jeans, sneakers, jackets');
  console.log('🏠 Home: Decorative items, garden tools, plants, outdoor gear');
  console.log('🛒 Ready for professional shopping experience demo!');
  process.exit(0);
});